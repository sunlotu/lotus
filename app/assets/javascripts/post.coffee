$(document).on 'turbolinks:load', ->
    ...
    myDropzone.on 'success', (status, resp)->
      if resp.success
        ...
        htmlStr = "<div class='imgbox'>" +
          ...
          "<img src='http://ol1rqfn9r.bkt.clouddn.com/#{resp.qiniu_hash}?imageView2/1/w/300/h/300/q/90' alt='90' width='130' height='130'>" +
          "</a>" +
          "<div class='operation'>" +
          "<a data-confirm='确定删除图片吗？' rel='nofollow' data-method='DELETE' href='/posts/#{resp.id}'>" +
          "<i class='fa fa-trash trash-img'></i>" +
          "</a>" +
          "<a href='javascript:;' data-behaivor='lb-download' data-proc='#{resp.id}'>" +
          "<i class='fa fa-download download-img'></i>" +
          "</a>" +
          "</div>"
  ...
  $('[data-behaivor=lb-download]').on 'click', (e) ->
    ...
    document.location.href = "/api/posts/download?post_id=#{postId}"
